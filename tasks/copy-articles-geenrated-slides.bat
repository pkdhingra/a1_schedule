...
REM it should be other way round
REM call xcopy c:\f\0-buckets\5108_prompt\slides.kreatebots.com\input\content\  c:\e\a3_input\kreatewebsites.com.slides\input\content\  /s /e /y /d
