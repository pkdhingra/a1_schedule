...
SET site=lohri.org
REM SET drive=NmXNVfme7yMk9D5IY20X_gdrive
REM SET article=NmXNVfme7yMk9D5IY20X_prompt
SET drive=nmxnvfme7ymk9d5iy20x_gdrive
SET article=nmxnvfme7ymk9d5iy20x_prompt
SET cms=festivals
SET topic=festivals
